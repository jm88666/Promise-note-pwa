  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      ...
      <div className="flex gap-2 mt-2">
        <button onClick={handleSpeech} className="bg-blue-500 text-white px-4 py-1 rounded">🎙️ Spreek</button>
        <button onClick={saveNote} className="bg-green-600 text-white px-4 py-1 rounded">💾 Opslaan</button>
      </div>
        ...
        {savedNotes.map((n) => (
          <div key={n.id} className="border p-2 mb-2 rounded">
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              <button onClick={() => deleteNote(n.id)} className="bg-red-500 text-white px-2 py-1 rounded">🗑️ Verwijder</button>
